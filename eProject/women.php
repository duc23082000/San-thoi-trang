<?php
require("config.php");
$sql = "SELECT * FROM product where gender='women'";
...
<head>
    ...
    <title>Gracious Garments - Men Page</title>
                ...
                <center>
                    <nav class="nav-menu mobile-menu">
                        <ul>
                            ...
                            <li class="active"><a href="./men.php">Men</a>
                                <ul class="dropdown">
                            ...
                            ?>
                                <div class="col-lg-4 col-sm-6">
                                    <div class="product-item">
                                        <div class="pi-pic">
                                        <a href="http://localhost:8080/BTaptech/priojecky1/eProject/product.php?id=<?php echo $row['id']?>">  <img src="<?php echo $row['img'] ?>" alt=""></img></a>
                                            <div class="icon">
                                                <i class="icon_heart_alt"></i>
                                            </div>
                                            <ul>
